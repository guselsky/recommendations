var project = 'recommendations-theme',
gulp = require('gulp'),
...
gulp.task('watch', ['browserSync', 'sass'], function() {
    ...
    gulp.watch('**/*.php', browserSync.reload); 
    gulp.watch('development/scripts/**/*.js', ['scriptsRefresh'], browserSync.reload); 
});

// Sass task, will run when any SCSS files change & BrowserSync
// will auto-update browsers
gulp.task('sass', function () {
    return gulp.src('development/styles/**/*.scss', ['sass'])
        .pipe(sass({     
...
gulp.task('browserSync', function() {
    ...
    proxy: "localhost/recommendations",
    notify: false
    });
});
...
gulp.task('modernizr', function() {
    return gulp.src(['./development/styles/**/*.css', './development/scripts/**/*.js'])
    .pipe(modernizr({
        'options': [
            'setClasses'
        ]
