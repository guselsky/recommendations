...
var Search = function () {
	function Search() {
		...
		this.searchInputField = (0, _jquery2.default)('.site-header__form-input');
	...
	_createClass(Search, [{
		...
		value: function openCloseOverlay(e) {
		...
		key: 'clickCloseOverlay',
		value: function clickCloseOverlay() {
