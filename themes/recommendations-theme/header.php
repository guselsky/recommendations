	...
	<header id="masthead" class="site-header container-1200">
		...
		<nav id="site-navigation" class="site-header__navigation">
			<ul class="main-navigation">
				...
				<li class="btn btn--small btn--blue user-registration-links__register"><a href="#">Register</a></li>
				<li class="user-registration-links__login"><a class="btn btn--small btn--green" href="#">Login</a></li>
